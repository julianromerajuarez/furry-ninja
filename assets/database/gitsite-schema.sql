...
--
-- Host: localhost    Database: sandbox_d7_www2
-- ------------------------------------------------------
...
) ENGINE=InnoDB AUTO_INCREMENT=311 DEFAULT CHARSET=utf8 COMMENT='Contains the individual links within a menu.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `watchdog` (
  ...
  KEY `type` (`type`),
  KEY `uid` (`uid`)
) ENGINE=InnoDB AUTO_INCREMENT=67 DEFAULT CHARSET=utf8 COMMENT='Table that contains logs of all system events.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2012-04-25 10:36:34
